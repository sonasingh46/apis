...
func (c *cStorVolumes) Get(name string, options metav1.GetOptions) (result *v1.CStorVolume, err error) {
...
func (c *cStorVolumes) List(opts metav1.ListOptions) (result *v1.CStorVolumeList, err error) {
...
func (c *cStorVolumes) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cStorVolumes) Create(cStorVolume *v1.CStorVolume) (result *v1.CStorVolume, err error) {
	result = &v1.CStorVolume{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cstorvolumes").
...
func (c *cStorVolumes) Update(cStorVolume *v1.CStorVolume) (result *v1.CStorVolume, err error) {
	result = &v1.CStorVolume{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cstorvolumes").
...
func (c *cStorVolumes) UpdateStatus(cStorVolume *v1.CStorVolume) (result *v1.CStorVolume, err error) {
	result = &v1.CStorVolume{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cstorvolumes").
...
func (c *cStorVolumes) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *cStorVolumes) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *cStorVolumes) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CStorVolume, err error) {
	result = &v1.CStorVolume{}
