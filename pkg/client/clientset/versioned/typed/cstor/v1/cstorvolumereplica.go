...
func newCStorVolumeReplicas(c *CstorV1Client, namespace string) *cStorVolumeReplicas {
...
func (c *cStorVolumeReplicas) Get(name string, options metav1.GetOptions) (result *v1.CStorVolumeReplica, err error) {
	result = &v1.CStorVolumeReplica{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *cStorVolumeReplicas) List(opts metav1.ListOptions) (result *v1.CStorVolumeReplicaList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.CStorVolumeReplicaList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cstorvolumereplicas").
...
func (c *cStorVolumeReplicas) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cStorVolumeReplicas) Create(cStorVolumeReplica *v1.CStorVolumeReplica) (result *v1.CStorVolumeReplica, err error) {
	result = &v1.CStorVolumeReplica{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cstorvolumereplicas").
...
func (c *cStorVolumeReplicas) Update(cStorVolumeReplica *v1.CStorVolumeReplica) (result *v1.CStorVolumeReplica, err error) {
	result = &v1.CStorVolumeReplica{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cstorvolumereplicas").
...
func (c *cStorVolumeReplicas) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *cStorVolumeReplicas) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
...
func (c *cStorVolumeReplicas) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1.CStorVolumeReplica, err error) {
	result = &v1.CStorVolumeReplica{}
