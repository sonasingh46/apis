...
import (
	...
	v1 "github.com/sonasingh46/apis/pkg/client/listers/cstor/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.CstorV1().CStorVolumes(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CstorV1().CStorVolumes(namespace).Watch(options)
			},
		},
		&cstorv1.CStorVolume{},
		resyncPeriod,
...
func (f *cStorVolumeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cstorv1.CStorVolume{}, f.defaultInformer)
}

func (f *cStorVolumeInformer) Lister() v1.CStorVolumeLister {
	return v1.NewCStorVolumeLister(f.Informer().GetIndexer())
}
